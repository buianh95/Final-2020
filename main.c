...
void red_color(int argc, char *argv[]){
	...
	printf("Result of red color is %lf \n", analyze(ave));
	
}

void green_color(int argc, char *argv[]){
    ...
    printf("Result of green color is %lf \n", analyze(ave));
    
}

void blue_color(int argc, char *argv[]){
    ...
    printf("Result of blue color %lf \n", analyze(ave));
